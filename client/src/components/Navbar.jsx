...
import { UserPlus, Video, User, LogOut, Shield, Zap, Globe, MessageSquare } from 'lucide-react'
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-[#223640]/80 bg-[#142229]/90 backdrop-blur-xl transition-all">
      <div className="mx-auto flex h-14 sm:h-16 max-w-7xl items-center justify-between px-3 sm:px-6 lg:px-8">
        {/* Brand - Leo Cerso Style */}
        <div className="flex items-center gap-2 sm:gap-3 cursor-pointer" onClick={() => onNavigate?.('home')}>
          <div className="relative flex h-8 w-8 sm:h-10 sm:w-10 items-center justify-center rounded-xl bg-[#E09800]">
